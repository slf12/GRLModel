...
def inception_v3_roi_head(inputs,
                  rois,
                 dropout_keep_prob=0.8,
                 num_classes=1000,
                 is_training=True,
    ...
    with scopes.arg_scope([ops.conv2d, ops.fc, ops.batch_norm, ops.dropout],
      ...
      with scopes.arg_scope([ops.conv2d, ops.max_pool, ops.avg_pool],
        ...
        with tf.variable_scope('logits'):
          ...
          logits_head_before = ops.fc(net_global, 9, activation=None, scope='logits/before/head', restore=restore_logits)
          logits_head = ops.fc(net_head, 6, activation=None, scope='logits/head', restore=restore_logits)
          logits_body = ops.fc(net_body, 9, activation=None, scope='logits/body', restore=restore_logits)
          logits_leg = ops.fc(net_leg, 6, activation=None, scope='logits/leg', restore=restore_logits)
          logits_after_head = ops.fc(net_global, 21, activation=None, scope='logits/after/head', restore=restore_logits)
    ...
    with scopes.arg_scope([ops.conv2d, ops.fc, ops.batch_norm, ops.dropout],
      ...
      with scopes.arg_scope([ops.conv2d, ops.max_pool, ops.avg_pool],
        ...
        with tf.variable_scope('logits'):
          ...
          fc.append(fc_2)
          fc_3 = ops.fc(net_global, 2048, activation=None, scope='fc_3', restore=restore_logits)
          fc.append(fc_3)
          fc_4 = ops.fc(net_global, 2048, activation=None, scope='fc_4', restore=restore_logits)
          fc.append(fc_4)
          rois_head = tf.slice(rois, [0, 0], [rois.get_shape()[0], 4])
          rois_body = tf.slice(rois, [0, 4], [rois.get_shape()[0], 4])
          rois_leg = tf.slice(rois, [0, 8], [rois.get_shape()[0], 4])
          ...
          fc_8 = ops.fc(net_global, 2048, activation=None, scope='fc_8', restore=restore_logits)
          fc.append(fc_8)
          fc_9 = ops.fc(net_global, 2048, activation=None, scope='fc_9', restore=restore_logits)
          fc.append(fc_9)
          fc_10 = ops.fc(net_global, 2048, activation=None, scope='fc_10', restore=restore_logits)
          fc.append(fc_10)
    ...
    with scopes.arg_scope([ops.conv2d, ops.fc, ops.batch_norm, ops.dropout],
      ...
      with scopes.arg_scope([ops.conv2d, ops.max_pool, ops.avg_pool],
        ...
        with tf.variable_scope('logits'):
          ...
          fc_8 = ops.fc(net_global, 2048, activation=None, scope='fc_8')
          fc.append(fc_8)
          fc_9 = ops.fc(net_global, 2048, activation=None, scope='fc_9')
          fc.append(fc_9)
          fc_10 = ops.fc(net_global, 2048, activation=None, scope='fc_10')
          fc.append(fc_10)
          ...
          fc.append(fc_2)
          fc_3 = ops.fc(net_global, 2048, activation=None, scope='fc_3')
          fc.append(fc_3)
          fc_4 = ops.fc(net_global, 2048, activation=None, scope='fc_4')
          fc.append(fc_4)

          output = []
          class_num = [6,9,6,5,8,8,1,3,3,2]
          lstm = tf.nn.rnn_cell.BasicLSTMCell(2048, state_is_tuple=True)
          if is_training:
            lstm =  tf.nn.rnn_cell.DropoutWrapper(
                  lstm,output_keep_prob=dropout_keep_prob
          ...
          logits = tf.concat(logit[6:10] + logit[0:6], 1, name='logits')
          logits = ops.batch_norm(logits, scale=True, activation=None, scope='logits_bn', restore=restore_logits)
